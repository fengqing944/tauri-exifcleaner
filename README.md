...
安装包文件名会随版本号变化，例如 `TagSweep_0.1.8_x64-setup.exe`。

## 发布信息

- 更新日志: [`CHANGELOG.md`](./CHANGELOG.md)
- Release Notes: [`release/0.1.8/RELEASE_NOTES.md`](./release/0.1.8/RELEASE_NOTES.md)
- Windows 安装包 SHA256: [`release/0.1.8/TagSweep_0.1.8_x64-setup.exe.sha256`](./release/0.1.8/TagSweep_0.1.8_x64-setup.exe.sha256)
