        ...
        <div className="details-drawer-body utility-drawer-body">
          ...
          <section className="utility-section">
            ...
            <div className="utility-chip-row">
              <span className="topbar-meta-chip">图片: JPG PNG WEBP HEIC GIF TIFF</span>
              <span className="topbar-meta-chip">视频/音频: MP4 MOV M4V AVI MP3 WAV</span>
              <span className="topbar-meta-chip">文档: PDF AI PSD EPS</span>
              <span className="topbar-meta-chip">相机 RAW: CR2 CR3 ARW DNG NEF RAF</span>
            </div>
          </section>
          ...
          <section className="utility-section">
            ...
            <ul className="utility-list">
              ...
              <li>
                <kbd>↑</kbd> / <kbd>↓</kbd> 切换队列行，<kbd>Enter</kbd> 或 <kbd>Space</kbd>{" "}
                固定当前预览。
              </li>
              <li>
                <kbd>Esc</kbd> 关闭字段浮层、运行详情、帮助或设置抽屉。
              </li>
